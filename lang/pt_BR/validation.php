...
return [
    ...
    */
    'custom' => [
        'book' => [
            'name' => 'O campo :attribute deve ser um nome válido contendo apenas letras, números, pontuações e espaços.',
        ],
        'person' => [
            'name' => 'O campo :attribute deve ser um nome válido contendo apenas letras e espaços.',
        ],
    ],
